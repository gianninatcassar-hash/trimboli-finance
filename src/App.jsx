...
<section id="home" className="relative">
  ...
  <div className="w-full">
    <img
      ...
      className="w-full h-[32vh] md:h-[42vh] object-contain bg-slate-200"
    />
  </div>
  ...
  <div className="bg-white py-12 px-6 sm:px-8 text-center">
    ...
    <p className="mt-4 text-slate-600 text-lg">{BRAND.tagline}</p>
    ...
    <div className="mt-6 flex flex-wrap justify-center gap-4">
      ...
      <a
        href="#services"
        className="rounded-xl px-6 py-3 font-semibold text-slate-900 border border-slate-300"
      >
        Our services
      </a>
    </div>
...
<section id="reviews" className="py-20" style={{ background: COLORS.paper }}>
  <div className="mx-auto max-w-6xl px-4">
    ...
    <div className="mt-10 grid gap-6 md:grid-cols-2">
      {[
        { name: "Sarah M.", text: "After months with struggling to get a pre-approval due to being self-employed, Rocky was able to get a pre-approval in weeks and us into our new home. We couldn't be happier." },
